---
description: "Describes the Attributed Revenue dashboard that breaks down attributed revenue and deals by channel subchannel and campaign over time"
...
![What was the breakdown of attributed revenue by channel last month?](assets/attributed-dashboard-4.png)
...
![Click the "+" icon beside each Channel to reveal the breakdown by](assets/attributed-dashboard-5.png)
...
![Click a branch to delve deeper into the subsequent hierarchy layer.](assets/attributed-dashboard-6.png)
