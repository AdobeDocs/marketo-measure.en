...
![What was the breakdown of attributed opportunity amount by channel last month?](assets/attributed-dashboard-3.png)
...
![Click the + icon beside each Channel to reveal the breakdown by](assets/attributed-dashboard-1.png)
...
![Click on a branch to delve deeper into the subsequent hierarchy layer.](assets/attributed-dashboard-2.png)
