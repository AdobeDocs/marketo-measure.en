...
![All Marketo Measure customers using Marketo Measure and Salesforce](assets/bizible-guide-1.png)
...
![Buyer Attribution Touchpoints with Opportunities](assets/bizible-guide-2.png)
...
When you are familiar with the "_[!DNL Marketo Measure] 101…_" reports, you may want to recreate them from custom report types for more custom reporting needs. Creating the [[!DNL Marketo Measure] Custom Report Types](/help/marketo-measure-salesforce-reporting/creating-report-types.md) will allow you to pull in custom fields that you might commonly use in other CRM reports. This will help you take you [!DNL Marketo Measure] reporting to the next level!
