---
description: PostLC Touchpoints and Lead Engagement
...
![Lead record showing PostLC touchpoints in Salesforce](assets/1.png)
...
![PostLC touchpoint list capped to four most recent submissions](assets/2.png)
...
1. Input the number of postLC touchpoints you'd like to push to your Leads and click **[!UICONTROL Save]**.
   ...
   ![Lead settings page to set PostLC touchpoint limit](assets/3.png)
...
1. Input the number of postLC touchpoints you'd like to push to your Contacts and click **[!UICONTROL Save]**.
   ...
   ![Contact settings page to set PostLC touchpoint limit](assets/4.png)
