...
Support Article: [Difference Between Buyer Touchpoints and Buyer Attribution Touchpoints](/help/configuration-and-setup/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
...
The [attribution models](/help/attribution-models.md) providing the best insight into people-based metrics are:
...
The [attribution models](/help/attribution-models.md) providing best insight into Opportunity-based metrics are:
...
![Marketo Measure simply looks at the 'Date' range to determine how](assets/bizible-guide-2.png)
...
![The screenshot above shows the Marketing Spend data over the past 3](assets/bizible-guide-3.png)
...
![Filter in on Marketing Channels, Subchannels, and/or Campaigns in which you know](assets/bizible-guide-4.png)
