...
![Marketo Measure Post-Lead Creation (PostLC) touchpoints are available for customers using](assets/additional-functionality-1.png)
...
![PostLC touchpoints are dynamic. As a Lead or Contact continues to submit](assets/additional-functionality-2.png)
...
1. Input the number of postLC touchpoints you'd like to push to your Leads and click **[!UICONTROL Save]**.
   ...
   ![1. Input the number of postLC touchpoints you'd like to push to](assets/additional-functionality-3.png)
...
1. Input the number of postLC touchpoints you'd like to push to your Contacts and click **[!UICONTROL Save]**.
   ...
   ![1. Input the number of postLC touchpoints you'd like to push to](assets/additional-functionality-4.png)
