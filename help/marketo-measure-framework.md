...
>[!NOTE]
>For instructions on how to add the Marketo Measure JS, [click here](/help/marketo-measure-tracking/adding-marketo-measure-script.md).
...
![Marketo Measure integrates with CRMs to house and organize all the data](assets/overview-resources-14.png)
...
![Most marketers rely on a few different applications to run their marketing](assets/overview-resources-15.png)
