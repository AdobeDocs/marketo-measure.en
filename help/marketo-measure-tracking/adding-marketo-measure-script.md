...
More information can be [found here](/help/marketo-measure-tracking/adding-marketo-measure-script-via-google-tag-manager.md){target="_blank"}.
...
* Solution: you need to force one of the forms to report the user to [!DNL Marketo Measure] based on cached data and discuss abandonment practices. Generally, [report user code](/help/marketo-measure-tracking/ajax-form-handling.md){target="_blank"} can solve for this.
...
* Solution: These [report user templates](/help/marketo-measure-tracking/ajax-form-handling.md){target="_blank"} can be used by your web dev team to add the needed code.
