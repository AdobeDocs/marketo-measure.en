...
>[!CAUTION]
>
>This article outlines Single Sign On (SSO) and advanced CRM User Management. If your account was provisioned **after 9/10/2020**, disregard this article, as SSO and Identity Management will be set up within the [Adobe Admin Console for your [!DNL Marketo Measure] integration](/help/implementation-guide.md).
...
![To get started, navigate to Settings Security Authentication page in the](assets/compliance-resources-1.png)
...
![b. Hint: If you test your SAML configuration now, we will parse](assets/discover-control-1.png)
...
![c. If multiple roles or groups should be mapped to a role,](assets/discover-control-2.png)
...
![b. If you see a "failure" error, follow the message and attempt](assets/discover-control-3.png)
...
![a. Important: Once you Save your new Authentication settings, it is possible](assets/discover-control-3.png)
...
![c. Congratulations! You've successfully set up Single Sign On into the](assets/discover-control-3.png)
...
![For Salesforce Roles, use the name of each Role. All Roles](assets/discover-control-3.png)
...
![For Dynamics Roles, use the name of each Security Role. All](assets/discover-control-3.png)
...
![Once Custom SSO has been set up, the Users page is](assets/discover-control-3.png)
