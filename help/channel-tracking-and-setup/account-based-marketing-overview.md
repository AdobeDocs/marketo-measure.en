...
For detailed instructions for setting up ABM within your [!DNL Salesforce] instance, go to [Setting up ABM page layout in Salesforce](/help/channel-tracking-and-setup/account-based-marketing-overview.md){target="_blank"}.
...
1. Go to [!UICONTROL Fields] and move the field "Predictive Engagement Score" into your Account Information section.
   ...
   ![1. Go to Fields and move the field "Predictive Engagement Score"](assets/account-marketing-3.png)

1. Finally, go to [!UICONTROL Related Lists] and move the "Leads" Related List into your page layout.

   ![1. Finally, go to Related Lists and move the "Leads" Related](assets/account-marketing-4.jpg)
...
1. Click **[!UICONTROL Fields]** and add the [!UICONTROL Account] field where you see fit on the page.
   ...
   ![1. Click Fields and add the Account field where you](assets/account-marketing-5.png)
