...
![Your upload date would be three weeks later than the conference date.](assets/dynamics-lists-1.png)
...
![Make sure you update the Touchpoint date before you enable Touchpoints for](assets/dynamics-lists-10.png)
...
![To create a Campaign in Salesforce, navigate to the Campaigns](assets/dynamics-lists-2.png)
...
![When you are creating this campaign, click the "Enable Buyer Touchpoints"](assets/dynamics-lists-3.png)
