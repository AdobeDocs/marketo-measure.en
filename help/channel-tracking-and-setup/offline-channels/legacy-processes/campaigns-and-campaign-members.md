...
![Salesforce Campaign page layout showing Enable Buyer Touchpoints field](assets/1.png)

The options available in the picklist are:

![Enable Buyer Touchpoints picklist dropdown with campaign member inclusion options](assets/2.png)
...
![Campaign record showing Touchpoint Start Date and Touchpoint End Date fields](assets/3.png)
...
![Campaign Member record showing Touchpoint Status fields for Lead, Contact, Opportunity, and Status Date](assets/4.png)
...
![Campaign Member record with Buyer Touchpoint Date field for date override](assets/5.png)
...
![Campaign page layout with Bulk Update Touchpoint Date button](assets/6.png)
...
![Bulk Update interface showing unsupported search for null Buyer Touchpoint Dates](assets/7.png)
...
![Bulk Update Touchpoint Date interface with calendar picker and Update Selected Records button](assets/8.png)

## Campaign Costs {#campaign-costs}

Learn all about Campaign Costs [in this article](/help/marketing-spend/crm-campaign-costs.md){target="_blank"}.
