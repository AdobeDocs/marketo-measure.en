...
>[!NOTE]
>
>This channel mapping is done in the Offline Channels section of the [!DNL Marketo Measure] app since we are using SFDC campaigns.
...
[!DNL Marketo Measure] is able to retroactively generate touchpoints for interactions that occurred in the past, as long as they're organized into Campaigns within Dynamics.
...
Please follow the instructions below for organizing historical data in Dynamics in a format that can be synced to [!DNL Marketo Measure].
