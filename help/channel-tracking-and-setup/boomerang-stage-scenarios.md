...
![Lead 1 is then converted in to a Contact with an Opportunity,](assets/boomerang-stages-18.png)
...
![In this scenario, a customer has chosen only to track the SQL](assets/boomerang-stages-19.png)
...
![This scenario uses the same criteria as scenario 2. A customer has](assets/boomerang-stages-20.png)
...
![In this scenario, a customer has chosen to track the MQL and](assets/boomerang-stages-21.png)
...
![All the touchpoints from Lead 1 are included on the opportunity, from](assets/boomerang-stages-22.png)
...
![In this scenario, a customer has chosen to track the MQL, SQL,](assets/boomerang-stages-23.png)
...
![In this scenario, a customer has chosen to track the MQL, SQL,](assets/boomerang-stages-25.png)
...
![In this scenario, a customer has chosen to track the Demo and](assets/boomerang-stages-25.png)
