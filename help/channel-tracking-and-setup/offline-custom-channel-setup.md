...
![The spreadsheet has three columns:](assets/offline-channels-1.png)
...
![The SFDC campaign types will appear in the Offline Channel's tab, listed](assets/offline-channels-10.jpg)
...
![This is where you can create the Channel/Subchannel mapping in the](assets/offline-channels-11.png)
...
![Below is an example of logic that Marketo Measure would not](assets/offline-channels-12.png)
...
![In the scenario above, you will want to create a unique Campaign](assets/offline-channels-13.png)
...
Learn more about [syncing offline [!DNL Salesforce] Campaigns with [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
![Another tip for handling campaigns for online activities is to map the](assets/offline-channels-14.png)
...
![Once you've edited and updated the spreadsheet with your custom rules, the](assets/offline-channels-20.png)
...
>
>* [Marketo Engage Programs Integration](/help/marketo-engage-programs-integration.md){target="_blank"}
