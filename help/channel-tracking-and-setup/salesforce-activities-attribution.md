...
![The Marketo Measure Salesforce Activities integration brings in specific Task and](assets/activities-attribution-10.png)
...
![If you want to set a unique Campaign for each Sales rep](assets/activities-attribution-11.png)
...
![The rules act as a filter to tell us which records are](assets/activities-attribution-12.png)
...
![With your package installation, Marketo Measure includes a custom Buyer Touchpoint](assets/activities-attribution-13.png)
...
![Do not forget to set different rules for Tasks or Events. You](assets/activities-attribution-5.png)
...
![| Matches Any (Contains) | Multiple values - &42;value&42;, &42;value, &42;value&42; |](assets/activities-attribution-8.png)
...
![And last but not least, you have the option of entering costs](assets/activities-attribution-9.png)

>[!MORELIKETHIS]
>
>[Activity Attribution FAQ](/help/channel-tracking-and-setup/activities-attribution-faq.md)
