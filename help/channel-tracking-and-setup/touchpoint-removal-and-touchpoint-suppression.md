...
![Choose from a list of Operators that will relate to the next](assets/touchpoint-settings-10.png)
...
![Or, add new statements outside of the group to utilize "OR" logic](assets/touchpoint-settings-11.png)
...
![3) If your rules get complex and you need to recreate groups](assets/touchpoint-settings-6.png)

If you make a mistake, don't worry. You can delete individual rows of your statement or full groups, too.

![If you make a mistake, don't worry. You can delete individual rows](assets/touchpoint-settings-7.png)
...
![4) Set up rules for the Buyer Attribution Touchpoints if you want](assets/touchpoint-settings-8.png)
