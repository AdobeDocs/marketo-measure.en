...
> [Custom Campaign Sync - App Sync](/help/channel-tracking-and-setup/custom-campaign-sync.md)
> [Syncing Offline Campaigns - CRM Sync](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
> [Offline Campaign & Campaign Members - CRM Sync](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
> [Campaign Sync Dates - CRM Sync](/help/channel-tracking-and-setup/campaign-sync-dates.md)
> [Configurations for Multiple Campaign Record Types](/help/channel-tracking-and-setup/configurations-record-types.md)
> [Creating a Campaign List View](/help/channel-tracking-and-setup/creating-a-campaign-list-view-for-salesforce-campaigns.md)
> [Syncing Historical Data](/help/channel-tracking-and-setup/syncing-historical-data.md)
