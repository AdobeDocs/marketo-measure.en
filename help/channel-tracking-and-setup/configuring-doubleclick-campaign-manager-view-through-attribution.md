...
>[!NOTE]
>
>If you are using the [!DNL Marketo Measure] and [!DNL DoubleClick Campaign Manager] integration, we require an [API connection](/help/api-connections/integrated-ad-platforms.md) so we can download details of the campaigns and creatives to resolve the ads.
...
For more information about the [!DNL Marketo Measure] View Through Attribution functionality, refer to [Marketo Measure View Through Attribution FAQ](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md).
...
1. Once it's added, confirm the delimiters are mapped as follows. This should be automatic once the tag is applied:
   ...
   ![n = %n Random Number Macro](assets/view-attribution-1.png)
