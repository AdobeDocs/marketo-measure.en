...
![To sync historical online data, the data must be organized into Salesforce](assets/dynamics-lists-1.png)
...
![If the data is housed elsewhere (such as still living in Marketing](assets/dynamics-lists-10.png)
...
More information on Syncing Marketing Lists can be found here: [[!DNL Dynamics] Campaigns and Marketing Lists](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
