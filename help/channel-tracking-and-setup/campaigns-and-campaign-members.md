...
![The Marketo Measure Salesforce Package will include a field labeled](assets/dynamics-lists-1.png)

The options available in the picklist are:

![The options available in the picklist are:](assets/dynamics-lists-10.png)
...
![If before using Marketo Measure, you used a Marketing Automation platform](assets/dynamics-lists-2.png)
...
![If enabled, Marketo Measure will push a status value onto the](assets/dynamics-lists-3.png)
...
![This could be necessary if a list was uploaded days/weeks/months after an](assets/dynamics-lists-4.png)
...
![The Bulk Update Touchpoint Date is included in the installed Marketo](assets/dynamics-lists-5.png)
...
![There is one search that does not work, which is displayed in](assets/legacy-processes-10.png)
...
![Once your date and time is set, click the Update Selected](assets/dynamics-lists-6.png)

## Campaign Costs {#campaign-costs}

Learn all about Campaign Costs [in this article](/help/crm-campaign-costs.md){target="_blank"}.
