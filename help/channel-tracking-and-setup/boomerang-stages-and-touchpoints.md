...
>[!NOTE]
>
>[Instructions on how to set up Boomerang Stages](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![Without Boomerang stages (the "before"), you only see the most recent MQL](assets/boomerang-stages-18.png)
...
![Using the example below, this Marketo Measure account has included MQL](assets/boomerang-stages-19.png)
