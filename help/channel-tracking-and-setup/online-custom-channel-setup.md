---
description: "Online Custom Channel Setup guidance for Marketo Measure users"
...
![The first step is to download the custom channel spreadsheet from the](assets/online-channels-1.png)

The spreadsheet has seven columns:

![The spreadsheet has seven columns:](assets/online-channels-2.png)
...
![The rows represent rules and the order in which Marketo Measure](assets/online-channels-3.png)
...
![Marketo Measure comes with 12 default channels for your use. These](assets/online-channels-4.png)
...
![Each parameter or component of the rule is separately mapped to the](assets/online-channels-5.png)
...
![The default channel 'Other' exists to catch data that does not meet](assets/online-channels-6.jpg)
