---
description: "Dynamics Campaigns and Marketing Lists guidance for Marketo Measure users"
...
>[!NOTE]
>
>This article covers an outdated process. We encourage users to use the [new, improved in-app process](/help/channel-tracking-and-setup/custom-campaign-sync.md){target="_blank"}.
...
![When Leads or Contacts get added to a Campaign directly, they're entered](assets/dynamics-lists-1.png)
...
![To include these records in the touchpoint journey, there are a few](assets/dynamics-lists-10.png)
...
![Marketo Measure does not support custom Response values.](assets/dynamics-lists-2.png)

These are the stock response values for the Campaign Response:

![These are the stock response values for the Campaign Response:](assets/dynamics-lists-3.png)
...
![One common example using this field is for events where a list](assets/dynamics-lists-4.png)
...
![Marketo Measure only supports Static Marketing Lists. We do not support](assets/dynamics-lists-5.png)
...
![To enable a Marketing List for touchpoints, there is a separate setting](assets/legacy-processes-10.png)
...
![The Touchpoint Date for a Marketing List is typically the ListMember created](assets/dynamics-lists-6.png)
...
![For each Campaign Type, it can be mapped to a Channel and](assets/dynamics-lists-7.png)

![For each Campaign Type, it can be mapped to a Channel and](assets/dynamics-lists-8.png)
