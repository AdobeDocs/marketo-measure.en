...
1. Go to the Object where the custom field lives and click the **[!UICONTROL Set History Tracking]** button.
   ...
   ![1. Go to the Object where the custom field lives and click](assets/custom-models-1.png)

1. Select the fields you wish to track changes on.

   ![1. Select the fields you wish to track changes on.](assets/custom-models-10.png)
