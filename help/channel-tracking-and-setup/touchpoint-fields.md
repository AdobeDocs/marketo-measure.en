...
![From the Marketo Measure Settings menu, navigate to the Touchpoint Fields](assets/touchpoint-fields-1.png)
...
![.&42; tells us that we are extracting the full string](assets/touchpoint-fields-10.png)
...
![Take note that you are using a forward slash and not a](assets/touchpoint-fields-11.png)
...
![{6} is the number of characters we are extracting](assets/touchpoint-fields-12.png)
...
![{6} is the number of characters we are extracting](assets/touchpoint-fields-13.png)
...
![There are campaigns that you've created for an "End of summer promotion"](assets/touchpoint-fields-2.png)
...
![To extract the 10, you would define the value as "BZ=\d{2}-\d{2}-\d{2}-\d{2}-(\d{2})"](assets/touchpoint-fields-3.png)
...
![There are separate fields on the Opportunity object for Segmentc and Gradec](assets/touchpoint-fields-4.png)
...
![The ability to create Segments using Touchpoint fields is available with this](assets/touchpoint-fields-5.png)
...
![Your setup would look something like the screenshot below. The Segment Name](assets/touchpoint-fields-6.png)

The rule references the same Touchpoint Field and searches for values that are "not equal to null."

![The rule references the same Touchpoint Field and searches for values that](assets/touchpoint-fields-7.png)
...
![There's an online tool (https://regex101.com/(https://regex101.com/){target="blank"}) that you can run and test](assets/touchpoint-fields-8.png)

![There's an online tool (https://regex101.com/(https://regex101.com/){target="blank"}) that you can run and test](assets/touchpoint-fields-9.png)
