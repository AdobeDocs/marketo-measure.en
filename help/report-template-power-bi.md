...
![Open the Adobe Marketo Measure Reporting Template Power BI file.](assets/marketo-bi-1.png)

You can find your specific Server, Warehouse, and Schema information in the [!DNL Marketo Measure] UI on the [!DNL Data Warehouse] information page. Instructions for how to locate this page are detailed [here](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
![To limit the data imported into the model, each table is set](assets/marketo-bi-2.png)
...
![Because the date filters are applied to the modified date of a](assets/marketo-bi-3.png)
...
![A few transformations have been applied to the data in Power Query.](assets/marketo-bi-6.png)
...
![Most tables in the Marketo Measure data warehouse contain denormalized dimensional](assets/marketo-bi-7.png)
...
![Tables and columns have been renamed to make them more user-friendly and](assets/marketo-bi-5.png)
...
![Since segment names are customizable, they have generic column names in the](assets/marketo-bi-4.png)
...
![/paste functions and filtering.](assets/marketo-bi-8.png)

![/paste functions and filtering.](assets/marketo-bi-11.png)
...
![To add currency conversion capabilities to the calculations in the model, we've](assets/marketo-bi-10.png)
...
![The Conversion Rate table stored in Snowflake contains a date range](assets/marketo-bi-9.png)

## Data Model {#data-model}

Click the image below for its full-size version.

[![Click the image below for its full-size version.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![The currency conversion measures in this model substitute a value of 1.0](assets/marketo-bi-13.png)

## Data Definitions {#data-definitions}

Definitions have been added to the Power BI model for tables, custom columns, and measures.

![Definitions have been added to the Power BI model for tables, custom](assets/marketo-bi-15.png)

![Definitions have been added to the Power BI model for tables, custom](assets/marketo-bi-16.png)

![Definitions have been added to the Power BI model for tables, custom](assets/marketo-bi-14.png)

To view definitions for columns coming directly from [!DNL Snowflake], see the [data warehouse documentation](/help/data-warehouse-schema.md){target="_blank"}
