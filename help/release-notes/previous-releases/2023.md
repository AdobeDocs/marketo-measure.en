...
See below for all the new and updated features for our 2023 releases.
...
The URL table in the [data warehouse](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} will now include a page title field, in addition to web data tables.
...
* [New Discover Dashboard Guide](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [Discover Dashboard Basics](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [Revenue Overview Dashboard](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Attributed Revenue Dashboard](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
* [ROI Dashboard](/help/marketo-measure-discover-ui/roi-dashboard.md){target="_blank"}
...
![Salesforce report type setup for Leads/Contacts with Touchpoints](assets/release-notes-2023-1.png)
...
![Report columns highlighting legacy Lead and Contact FT/LC fields to remove](assets/release-notes-2023-2.png)

* Add Touchpoint fields:

![Report columns showing Touchpoint fields to add in place of FT/LC fields](assets/release-notes-2023-3.png)
...
![Touchpoint Position filter configuration example](assets/release-notes-2023-4.png)

![Date field filter updated to Touchpoint-based fields](assets/release-notes-2023-5.png)
...
* The outdated method of OAuth with a RefreshToken will be deprecated. Refer to [this guide](/help/marketo-measure-and-dynamics/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} for updating your credentials to adhere to Microsoft's best practices of using ClientSecret.
