...
>[!MORELIKETHIS]
> [Update Buyer Touchpoint Package](/help/configuration-and-setup/install-set-up.md)
> [[!DNL Marketo Measure] Permission Sets](/help/configuration-and-setup/marketo-measure-permission-sets.md)
...
> [Connect Marketo Measure to Salesforce](/help/configuration-and-setup/connect-marketo-measure-to-salesforce.md)
