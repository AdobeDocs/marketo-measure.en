...
![Marketo Measure Objects relate to specific standard Salesforce Objects. This](assets/bizible-full-1.png)
...
![The BT Object is visible on Leads and Contacts pages as a](assets/bizible-taxonomy-1.png)
...
![The Marketo Measure Person Object relates the Lead and Contact objects](assets/connect-salesforce-2.png)
...
![If you are running A/B tests through Optimizely or VWO (Visual](assets/marketo-salesforce-8.png)
...
Data captured by the [!DNL Marketo Measure] JavaScript is pushed into the custom [!DNL Marketo Measure] Fields within the [!DNL Marketo Measure] Objects. Certain fields are present only on certain objects. You can review the [glossary of [[!DNL Marketo Measure] fields]](/help/glossary.md) and a [visualization of the related [!DNL Marketo Measure] Objects](/help/configuration-and-setup/marketo-measure-object-and-field-taxonomy.md).
