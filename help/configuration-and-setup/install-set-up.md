...
1. Select **[!UICONTROL Install] for All Users**.
   ...
   ![1. Select Install for All Users.](assets/bizible-full-1.png)

1. Once the installation is complete, you can view it.

   ![1. Once the installation is complete, you can view it.](assets/bizible-taxonomy-1.png)

After you've completed the installation, you can update your [[!DNL Salesforce] page layouts](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"} with the [!DNL Marketo Measure] fields if desired.

>[!NOTE]
>
>Read about the [!DNL Marketo Measure] Permissions sets created and [how they are used](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}.
...
>
>* [Adobe Admin Console Setup](/help/configuration-and-setup/adobe-admin-console-setup.md){target="_blank"}
