...
![Insights session list showing number of tracked sessions](assets/1.png)
...
![Insights roll-up view with touchpoint positions and channel details](assets/2.png)
...
![Insights session list highlighting A/B test beaker icon](assets/3.png)
...
![Session detail panel showing page views within a session](assets/4.png)
