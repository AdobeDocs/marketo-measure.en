...
Data captured by the [!DNL Marketo Measure] JavaScript is pushed into the custom [!DNL Marketo Measure] Fields within the [!DNL Marketo Measure] Objects. Certain fields are present only on certain objects. You can review the [glossary of [[!DNL Marketo Measure] fields]](/help/introduction/glossary.md) and a [visualization of the related [!DNL Marketo Measure] Objects](/help/configuration-and-setup/marketo-measure-and-salesforce/marketo-measure-object-and-field-taxonomy.md).
