---
description: "Page Layout Instructions guidance for Marketo Measure users"
...
1. Click **[!UICONTROL Page Layouts]**.
   ...
   ![1. Click Page Layouts.](assets/marketo-salesforce-7.jpg)

1. Click **[!UICONTROL Edit]** next to the page layout that you want to update.

   ![1. Click Edit next to the page layout that you want](assets/marketo-salesforce-1.jpg)
...
1. Within the [!UICONTROL fields] option, select the **[!UICONTROL Enable Buyer Touchpoints]** field and drag it wherever you would like on the page. Next, add the **[!UICONTROL Touchpoint Start Date]** and **[!UICONTROL Touchpoint End Date]** fields.
   ...
   ![1. Within the fields option, select the Enable Buyer Touchpoints](assets/bizible-full-1.png)
...
1. Drag the **[!UICONTROL Bulk Update Touchpoint Date]** button to your custom buttons section.
   ...
   ![1. Drag the Bulk Update Touchpoint Date button to your custom](assets/bizible-taxonomy-1.png)

1. Click **[!UICONTROL Save]**.

   >[!NOTE]
   >
   >If you are using multiple Campaign record types, you must update the picklist values for the **[!UICONTROL Enable Buyer Touchpoints]** field. Refer to [this article](/help/channel-tracking-and-setup/configurations-record-types.md) for instructions.
...
1. Click **[!UICONTROL Edit]** next to the page layout that you want to update. Keep in mind that multiple page layouts can contain the Buyer Touchpoints sections.

1. Click the VisualForce page option on the left within your quick find menu.
...
1. Drag the **[!UICONTROL Marketo Measure Lead Related List]** VisualForce page into your page layout section.
   ...
   ![1. Drag the Marketo Measure Lead Related List VisualForce page into](assets/connect-salesforce-1.png)
...
1. Drag the [!DNL Marketo Measure Insights] Canvas App into that newly created section. Click **Save**. Sometimes it's necessary to save the page layout first before dropping in the Canvas App because Salesforce doesn't instantly recognize it. So after creating the section, save the page layout and then re-edit to drag the canvas app within that section. This applies to every object.
   ...
   >[!NOTE]
   >
   >For the [!DNL Marketo Measure Insights] Canvas App to function properly, [permissions must be configured properly](/help/configuration-and-setup/marketo-measure-insights-configuration.md).

If you are using the [!DNL Marketo Measure] ABM feature, [click here for additional page layout instructions](/help/channel-tracking-and-setup/account-based-marketing-overview.md).
...
1. Select the Page Layout that you'd like to edit.
...
1. Sort By: Touchpoint Date, Ascending.
   ...
   ![1. Sort By: Touchpoint Date, Ascending.](assets/marketo-salesforce-15.jpg)

1. Expand the Buttons option and deselect **[!UICONTROL New]**.

   ![1. Expand the Buttons option and deselect New.](assets/marketo-salesforce-12.png)
...
If you are using the [!DNL Marketo Measure] ABM feature, review the [additional page layout instructions](/help/channel-tracking-and-setup/account-based-marketing-overview.md).
