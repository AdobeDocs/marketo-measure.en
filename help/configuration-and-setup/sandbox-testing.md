---
description: "Testing the Marketo Measure Integration with a Salesforce Sandbox guidance for Marketo Measure users"
...
Here are the two sources referenced for both phases of the testing. [Steps 1-4](https://help.salesforce.com/s/articleView?id=lead_import_wizard.htm&language=en_US&type=5) and [Steps 5-6](/help/channel-tracking-and-setup/syncing-offline-campaigns.md). It is recommended to review these documents as they provide more detail in some areas.
