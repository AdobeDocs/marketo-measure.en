...
[!DNL Salesforce] customers click [here](/help/configuration-and-setup/install-set-up.md).

[!DNL Microsoft Dynamics] customers click [here](/help/microsoft-dynamics-crm-installation-guide.md).
