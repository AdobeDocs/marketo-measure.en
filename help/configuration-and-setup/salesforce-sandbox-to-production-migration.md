...
* For more information about the [!DNL Marketo Measure] relationship with [!DNL Salesforce], look at [this article](/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md)
...
* You are prompted to confirm your deletion. Make sure to read over the prompt carefully and understand the consequences of the deletion
   ...
   ![You are prompted to confirm your deletion. Make sure to read over](assets/salesforce-migration-1.png)
...
[Page Layouts](/help/configuration-and-setup/page-layout-instructions.md)

[Permission Sets](/help/configuration-and-setup/marketo-measure-permission-sets.md)
...
[Hiding unnecessary report types](/help/configuration-and-setup/hiding-unnecessary-report-types.md)

[Custom workflow if applicable](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
