...
![First, you see in the middle part of your insights, the number](assets/marketo-app-1.png)
...
![The icons that look like paper indicate that a page view happened](assets/marketo-app-2.png)
...
![The icon that looks like a beaker signals that an A/B test](assets/marketo-app-3.png)
...
![If you click any specific session (you can do this by clicking](assets/marketo-app-4.png)
