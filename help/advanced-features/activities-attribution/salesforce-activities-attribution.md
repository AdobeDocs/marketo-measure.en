...
![Settings tab showing Activities configuration page for attribution rules](assets/1.png)
...
![Campaign Name field with dynamic replacement parameter example for Outbound Sales](assets/2.png)
...
![Activity rules configuration interface showing filter criteria with and/or statement options](assets/3.png)
...
![Buyer Touchpoint Date field selection showing standard and custom date field options](assets/4.png)
...
![Object type selector showing Tasks and Events options for activity rules](assets/5.png)
...
![Marketing Channel configuration page showing campaign mapping with wildcard operator options](assets/6.png)
...
![Marketing Spend upload interface for entering channel costs by month with ROI tracking](assets/7.png)

>[!MORELIKETHIS]
>[Activity Attribution FAQ](/help/advanced-features/activities-attribution/activities-attribution-faq.md)
