...
![Suppression rule builder showing grouped AND/OR logic](assets/2.png)
...
![Clone option to duplicate suppression rule groups](assets/3.png)

If you make a mistake, don't worry. You can delete individual rows of your statement or full groups, too.

![Delete icons for individual statements and rule groups](assets/4.png)
...
![Buyer Attribution Touchpoints suppression rules configuration](assets/5.png)
