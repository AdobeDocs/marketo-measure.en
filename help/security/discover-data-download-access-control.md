---
description: "[!UICONTROL Discover Data Download] Access Control"
...
1. Click **[!UICONTROL Data Access]** under [!UICONTROL Security].
   ...
   ![Security settings page with Data Access option highlighted](assets/discover-data-download-access-control-1.png)

1. Click the drop-down and select the appropriate option for your console.

   ![Data download access dropdown showing All Users, Admin Users Only, and None](assets/discover-data-download-access-control-2.png)
...
1. Click **[!UICONTROL Save]** when done.
   ...
   ![Discover data download policy saved confirmation](assets/discover-data-download-access-control-3.png)
