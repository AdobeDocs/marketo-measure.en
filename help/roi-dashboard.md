...
![Realized ROI: Realized attributed revenue divided by costs in the filtered date](assets/roi-dashboard-9.png)
...
![Are there any outlier channels or subchannels with unusually high or low](assets/roi-dashboard-8.png)
...
![How does the trend of Realized ROI relate to any significant marketing](assets/roi-dashboard-7.png)
...
![How have costs for a specific channel evolved over time?](assets/roi-dashboard-6.png)
...
![Which marketing avenues (channel, subchannel, or campaign) seem underfunded compared to others?](assets/roi-dashboard-5.png)
...
>[!MORELIKETHIS]
>
>* [Discover Dashboard Basics](/help/discover-dashboard-basics.md){target="_blank"}
>* [Dashboard Data Visibility Policy](/help/dashboard-data-visibility-policy.md){target="_blank"}
