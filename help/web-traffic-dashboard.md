...
![In which period did the website see the highest number of Unique](assets/web-dashboard-1.png)
...
![Lead creation from forms](assets/web-dashboard-2.png)
...
![Unique Visitors](assets/web-dashboard-3.png)
...
![How does the number of unique visitors compare to total visits within](assets/web-dashboard-4.png)
