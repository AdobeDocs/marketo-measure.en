...
![Hover over a visual's top-right corner to see a read-only list of](assets/discover-3b-1.png)
...
![Hover over a visual to identify if it has a hierarchy; the](assets/discover-basics-7.png)
...
![Activate drill-down by clicking the single downward arrow, highlighted by a gray](assets/discover-basics-8.png)

To drill down one field at a time, turn on the drill-down icon and select a visual element, such as a bar.

![To drill down one field at a time, turn on the drill-down](assets/discover-basics-2.gif)

Use the double arrow drill-down icon to advance to the next hierarchy level.

![Use the double arrow drill-down icon to advance to the next hierarchy](assets/discover-basics-1.gif)

Use the fork-like icon to add an additional hierarchy level in your current view.

![Use the fork-like icon to add an additional hierarchy level in your](assets/discover-basics-12.gif)

### Drill through {#drill-through}

To explore the data behind the visual, right-click the visual element and select the "drill-through" option.

![To explore the data behind the visual, right-click the visual element and](assets/discover-basics-13.gif)
...
![To export the underlying data from a visual, hover over its top-right](assets/discover-basics-6.gif)

### Focus Mode {#focus-mode}

To zoom in on a specific visual or tile, hover over the top-right corner and select the "focus" button.

![To zoom in on a specific visual or tile, hover over the](assets/discover-basics-5.gif)
...
![Selecting a value or axis label in one visualization will cross-filter other](assets/discover-basics-3.gif)
...
![Tooltips offer supplementary details about the displayed data. Hover over a visual](assets/discover-basics-4.gif)
