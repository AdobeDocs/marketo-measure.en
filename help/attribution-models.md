...
![Say Kate visits www.adobe.com for the first time via an Adwords Ad](assets/overview-resources-9.png)
...
![Continuing from the previous example, after Kate's first visit to www.adobe.com via](assets/overview-resources-10.png)
...
![Kate's first visit to www.adobe.com via an Adwords ad would receive 50%](assets/overview-resources-11.png)
...
![Hillary receives an email with a link to the pricing page and](assets/overview-resources-12.png)
...
![After the opportunity creation, Kate, Austin, and Hillary decide to pitch Marketo](assets/overview-resources-13.png)
