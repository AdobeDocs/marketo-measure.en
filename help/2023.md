...
The URL table in the [data warehouse](/help/data-warehouse-schema.md){target="_blank"} will now include a page title field, in addition to web data tables.
...
* [New Discover Dashboard Guide](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Discover Dashboard Basics](/help/discover-dashboard-basics.md){target="_blank"}
* [Revenue Overview Dashboard](/help/revenue-overview-dashboard.md){target="_blank"}
...
![Create new Report Types for Leads and Contacts with or without Touchpoints.](assets/release-notes-3.png)
...
![Remove Lead/Contact FT/LC fields:](assets/release-notes-5.png)

* Add Touchpoint fields:

![Add Touchpoint fields:](assets/release-notes-4.png)
...
![The Touchpoint Position filter and any filters that use the FT/LC fields,](assets/release-notes-2.png)

![The Touchpoint Position filter and any filters that use the FT/LC fields,](assets/release-notes-1.png)
...
* The outdated method of OAuth with a RefreshToken will be deprecated. Refer to [this guide](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} for updating your credentials to adhere to Microsoft's best practices of using ClientSecret.
...
[This article](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} includes guides on recreating reports and dashboards from the legacy Reporting packages.
