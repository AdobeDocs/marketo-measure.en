...
![You need to update the existing connection data to your specific Snowflake](assets/marketo-tableau-7.png)

## Data Connection {#data-connection}

You need to set up a data connection to your Snowflake instance. For this, you need the Server name along with your Username and Password. Details on where to find this information and reset your password, if needed, are documented [here](/help/data-warehouse-access-reader-account.md){target="_blank"}.

![You need to set up a data connection to your Snowflake instance.](assets/marketo-tableau-5.png)
...
![You will also need to enter an initial SQL command. This supports](assets/marketo-tableau-6.png)
...
![A few transformations have been applied to the data in Tableau](assets/marketo-tableau-1.png)

![A few transformations have been applied to the data in Tableau](assets/marketo-tableau-2.png)
...
![To add currency conversion capabilities to the calculations in the model, we've](assets/marketo-tableau-4.png)
...
![There are a few places where two tables from Snowflake have](assets/marketo-tableau-3.png)
...
![The CATEGORY column lists the category number and the SEGMENTNAME column](assets/marketo-tableau-13.png)
...
![Names can be updated in two ways. The first option is to](assets/marketo-tableau-14.png)

The other option is to rename the columns directly in the [!DNL Tableau] table.

![The other option is to rename the columns directly in the](assets/marketo-tableau-9.png)

## Data Model {#data-model}

Click the image below for its full-size version.

[![Click the image below for its full-size version.](assets/marketo-tableau-8.png)](assets/tableau-model-1.png){target="_blank"}
...
![Both Cost and Touchpoint data share Channel and Campaign dimensions. However, Tableau](assets/marketo-tableau-10.png)
...
![Convert the value from corporate to selected currency value in corporate currency](assets/marketo-tableau-11.png)
...
![The currency conversion measures in this model substitute a value of 1.0](assets/marketo-tableau-12.png)

## Data Definitions {#data-definitions}

Definitions have been added to the [!DNL Tableau model] for parameters, custom columns, and measures.

![Definitions have been added to the Tableau model for parameters, custom](assets/marketo-tableau-15.png)
