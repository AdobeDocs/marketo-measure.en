...
1. Select [!UICONTROL Credentials] or [!UICONTROL OAuth].
   ...
   >[!NOTE]
   >
   >For more information on OAuth, visit [this article](/help/oauth-with-azure-active-directory-for-dynamics-crm.md). If you have any questions about the process, contact your [!DNL Marketo Measure] Account representative.
