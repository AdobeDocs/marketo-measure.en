...
# Marketo Measure Help Docs {#using}

+ [Overview](home.md)
+ Introduction to Marketo Measure {#introduction-to-bizible}
  + Overview Resources {#overview-resources}
    + [Marketing Attribution](introduction-to-bizible/overview-resources/marketing-attribution.md)
    + [Marketo Measure Attribution Models](introduction-to-bizible/overview-resources/bizible-attribution-models.md)
    + [Marketo Measure Framework](introduction-to-bizible/overview-resources/bizible-framework.md)
    + [Glossary of Marketo Measure Fields](introduction-to-bizible/overview-resources/glossary-of-bizible-fields.md)
+ Marketo Measure Tracking {#bizible-tracking}
  + Setting Up Tracking {#setting-up-tracking}
    + [Best Practices for Implementing Marketo Measure JavaScript](bizible-tracking/setting-up-tracking/best-practices-for-implementing-bizible-javascript.md)
    + [Adding Marketo Measure Script](bizible-tracking/setting-up-tracking/adding-bizible-script.md)
    + [Adding Marketo Measure Script via Google Tag Manager](bizible-tracking/setting-up-tracking/adding-bizible-script-via-google-tag-manager.md)
    + Adding Marketo Measure Script to Different Form Providers {#adding-bizible-script-to-different-form-providers}
      + [Adding Marketo Measure JavaScript to Pardot](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-javascript-to-pardot.md)
      + [Adding Marketo Measure Script to Lightbox Forms](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-script-to-lightbox-forms.md)
      + [Adding Marketo Measure Script to Sitecore Pages](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-script-to-sitecore-pages.md)
      + [Adding Marketo Measure Script to Uberflip Forms](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-script-to-uberflip-forms.md)
      + [Adding Marketo Measure to Act-On Forms](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-to-act-on-forms.md)
      + [Adding Marketo Measure to Hubspot](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-to-hubspot.md)
      + [Adding Marketo Measure to Marketo Landing Pages](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/adding-bizible-to-marketo-landing-pages.md)
      ...
      + [Connecting Marketo Measure to Unbounce Script Manager](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/connecting-bizible-to-unbounce-script-manager.md)
      + [IFrame Forms and Marketo Measure](bizible-tracking/setting-up-tracking/adding-bizible-script-to-different-form-providers/iframe-forms-and-bizible.md)
    + [Excluding Marketo Measure from Specific Forms](bizible-tracking/setting-up-tracking/excluding-bizible-from-specific-forms.md)
    + [Marketo Measure Cookies](bizible-tracking/setting-up-tracking/bizible-cookies.md)
    + [Definition of Marketo Measure Web Sessions](bizible-tracking/setting-up-tracking/definition-of-bizible-web-sessions.md)
...
+ Configuration and Setup {#configuration-and-setup}
  + Getting Started with Marketo Measure {#getting-started-with-bizible}
    ...
    + [Difference Between Marketo Measure Touchpoints and Marketo Measure Attribution Touchpoints](configuration-and-setup/getting-started-with-bizible/difference-between-bizible-touchpoints-and-bizible-attribution-touchpoints.md)
    + [Explanation of Touchpoint Positions and Generation Across BTs and BATs](configuration-and-setup/getting-started-with-bizible/explanation-of-touchpoint-positions-and-generation-across-bts-and-bats.md)
    + [Marketo Measure Quick Start](configuration-and-setup/getting-started-with-bizible/bizible-quick-start.md)
  + Marketo Measure and Salesforce {#bizible-and-salesforce}
    + [Marketo Measure Installation Guide](configuration-and-setup/bizible-and-salesforce/bizible-installation-guide.md)
    + [Best Practices for Marketo Measure CRM Package](configuration-and-setup/bizible-and-salesforce/best-practices-for-bizible-crm-package.md)
    + [Marketo Measure Salesforce Objects](configuration-and-setup/bizible-and-salesforce/bizible-salesforce-objects.md)
    + [How Marketo Measure and Salesforce Interact](configuration-and-setup/bizible-and-salesforce/how-bizible-and-salesforce-interact.md)
    + [Marketo Measure Object and Field Taxonomy](configuration-and-setup/bizible-and-salesforce/bizible-object-and-field-taxonomy.md)
    + [Marketo Measure Fields on Standard Salesforce Objects](configuration-and-setup/bizible-and-salesforce/bizible-fields-on-standard-salesforce-objects.md)
    ...
    + [Creating a Marketo Measure Profile](configuration-and-setup/bizible-and-salesforce/creating-a-bizible-profile.md)
    + [Marketo Measure Permission Sets](configuration-and-setup/bizible-and-salesforce/bizible-permission-sets.md)
    + [Recommended Salesforce Permissions for Marketo Measure Connected User](configuration-and-setup/bizible-and-salesforce/recommended-salesforce-permissions-for-bizible-connected-user.md)
  ...
  + Marketo Measure Insights (Canvas App) {#bizible-insights-canvas-app}
    + [Marketo Measure Insights Explained](configuration-and-setup/bizible-insights-canvas-app/bizible-insights-explained.md)
    + [Marketo Measure Insights Configuration](configuration-and-setup/bizible-insights-canvas-app/bizible-insights-configuration.md)
...
+ API Connections {#api-connections}
  + Utilizing Marketo Measure's API Connections {#utilizing-bizibles-api-connections}
    + [Integrated Ad Platforms](api-connections/utilizing-bizibles-api-connections/integrated-ad-platforms.md)
    + [Best Practices for API Connections](api-connections/utilizing-bizibles-api-connections/best-practices-for-api-connections.md)
    + [How Bid Management Tools Affect Marketo Measure](api-connections/utilizing-bizibles-api-connections/how-bid-management-tools-affect-bizible.md)
    + [Marketo Measure Parameters](api-connections/utilizing-bizibles-api-connections/bizible-parameters.md)
...
+ Advanced Marketo Measure Features {#advanced-bizible-features}
  + Custom Attribution Models {#custom-attribution-models}
    ...
    + [Best Practices for Custom Model](advanced-bizible-features/custom-attribution-models/best-practices-for-custom-model.md)
    + [Best Practices for Stage Mapping](advanced-bizible-features/custom-attribution-models/best-practices-for-stage-mapping.md)
  ...
  + Touchpoint Settings {#touchpoint-settings}
    + [Best Practices for Touchpoint Settings](advanced-bizible-features/touchpoint-settings/best-practices-for-touchpoint-settings.md)
  ...
  + Segmentation {#segmentation}
    + [Best Practices for Segmentation](advanced-bizible-features/segmentation/best-practices-for-segmentation.md)
  ...
  + Activities Attribution {#activities-attribution}
    + [Best Practices for Activities Attribution](advanced-bizible-features/activities-attribution/best-practices-for-activities-attribution.md)
  ...
  + Custom Revenue Amount {#custom-revenue-amount}
    + [Best Practices for Utilizing a Custom Revenue Amount](advanced-bizible-features/custom-revenue-amount/best-practices-for-utilizing-a-custom-revenue-amount.md)
    ...
    + [Using Data Loader to Update Marketo Measure Custom Amount Field](advanced-bizible-features/custom-revenue-amount/using-data-loader-to-update-bizible-custom-amount-field.md)
  + View Through Attribution {#view-through-attribution}
    + [Marketo Measure View Through Attribution FAQ](advanced-bizible-features/view-through-attribution/bizible-view-through-attribution-faq.md)
...
+ Marketo Measure Discover UI {#bizible-discover-ui}
  ...
  + Using Marketo Measure's Reporting Platform {#using-bizibles-reporting-platform}
...
+ Marketo Measure and Adobe {#bizible-and-adobe}
  + [Bizible Integrations with Adobe Analytics](bizible-and-adobe/bizible-integrations-with-adobe-analytics.md)
  + [Domain Management](bizible-and-adobe/domain-management.md)
  + [Migration to Adobe Admin Console](bizible-and-adobe/migration-to-adobe-admin-console.md)
  + [Unified Shell Overview](bizible-and-adobe/unified-shell-overview.md)
+ Marketo Measure and Dynamics {#bizible-and-dynamics}
  + Getting Started with Marketo Measure and Dynamics {#getting-started-with-bizible-and-dynamics}
    + [Marketo Measure Dynamics Schema](bizible-and-dynamics/getting-started-with-bizible-and-dynamics/bizible-dynamics-schema.md)
    ...
    + [Marketo Measure Revenue Workflows for Dynamics](bizible-and-dynamics/getting-started-with-bizible-and-dynamics/bizible-revenue-workflows-for-dynamics.md)
    ...
    + [Marketo Measure and Dynamics Taxonomy](bizible-and-dynamics/getting-started-with-bizible-and-dynamics/bizible-and-dynamics-taxonomy.md)
...
+ Marketo Measure and Marketo {#bizible-and-marketo}
  + Marketo Measure Integrations with Marketo {#bizible-integrations-with-marketo}
...
+ Marketo Measure Salesforce Reporting {#bizible-salesforce-reporting}
  + New Report Types {#new-report-types}
    + [Creating Custom Marketo Measure Report Types](bizible-salesforce-reporting/new-report-types/creating-custom-bizible-report-types.md)
  ...
  + Marketo Measure Reports {#bizible-reports}
    + [Marketo Measure Reporting Guide](bizible-salesforce-reporting/bizible-reports/bizible-reporting-guide.md)
    + [Marketo Measure 101 Reports Overview](bizible-salesforce-reporting/bizible-reports/bizible-101-reports-overview.md)
    ...
    + [Leads with Marketo Measure Touchpoints Report](bizible-salesforce-reporting/bizible-reports/leads-with-bizible-touchpoints-report.md)
  ...
  + Additional Functionality {#additional-functionality}
    ...
    + [Duplicate Records and Marketo Measure](bizible-salesforce-reporting/additional-functionality/duplicate-records-and-bizible.md)
...
+ Marketo Measure Data Warehouse {#bizible-data-warehouse}
...
+ Security and Compliance {#security-and-compliance}
  + Compliance Related Resources {#compliance-related-resources}
    ...
    + [Ensuring Consent for GDPR in Marketo Measure Js](security-and-compliance/compliance-related-resources/ensuring-consent-for-gdpr-in-bizible-js.md)
...
+ Miscellaneous {#miscellaneous}
  + Other Related Resources {#other-related-resources}
    + [Marketo Measure Maintenance](miscellaneous/other-related-resources/bizible-maintenance.md)
    + [Marketo Measure Resource List](miscellaneous/other-related-resources/bizible-resource-list.md)
    + [Call Tracking Integration](miscellaneous/other-related-resources/call-tracking-integration.md)
    + [Difference between a Google Analytics Conversion and a Marketo Measure Touchpoint](miscellaneous/other-related-resources/difference-between-a-google-analytics-conversion-and-a-bizible-touchpoint.md)
    + [Email Tracking Parameter](miscellaneous/other-related-resources/email-tracking-parameter.md)
    + [Granting Salesforce Access to Marketo Measure Support](miscellaneous/other-related-resources/granting-salesforce-access-to-bizible-support.md)
    + [Privacy Request](miscellaneous/other-related-resources/privacy-requests.md)
    + [Remove Marketo Measure Tracking Parameters from the Landing Page URL in Google Analytics](miscellaneous/other-related-resources/remove-bizible-tracking-parameters-from-the-landing-page-url-in-google-analytics.md)
    + [Transitioning to Marketo Measure from Full Circle](miscellaneous/other-related-resources/transitioning-to-bizible-from-full-circle.md)
