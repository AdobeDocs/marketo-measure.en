...
1. Click **[!UICONTROL Data Access]** under [!UICONTROL Security].
   ...
   ![1. Click Data Access under Security.](assets/compliance-resources-1.png)

1. Click the drop-down and select the appropriate option for your console.

   ![1. Click the drop-down and select the appropriate option for your console.](assets/discover-control-2.png)
...
1. Click **[!UICONTROL Save]** when done.
   ...
   ![1. Click Save when done.](assets/discover-control-3.png)
