...
![How do the touchpoints per person compare from one quarter/month to the](assets/engagement-dashboard-1.png)
...
![How does the number of touchpoints compare to People Touched within a](assets/engagement-dashboard-2.png)
