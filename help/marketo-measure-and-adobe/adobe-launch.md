...
# [!DNL Marketo Measure] Integrations with Adobe Launch {#marketo-measure-integrations}
...
1. Click the property that you created.
   ...
   ![Adobe Launch property selection screen showing available properties](assets/marketo-measure-integrations-1.png)

1. Click **[!UICONTROL Extensions]**.

   ![Extensions tab in Adobe Launch property settings](assets/marketo-measure-integrations-2.png)

1. Click the **[!UICONTROL Catalog]** tab and search for "[!UICONTROL Bizible]."

   ![Extension catalog search showing Bizible extension](assets/marketo-measure-integrations-3.png)

1. In the [!UICONTROL Bizible Analytics] tile, click **[!UICONTROL Install]**.

   ![Bizible Analytics extension tile with Install button](assets/marketo-measure-integrations-4.png)

1. In the Bizible AccountId field, type in the URL of your website (for example, `adobe.com`).

   ![Bizible extension configuration with AccountId field](assets/marketo-measure-integrations-5.png)

1. Click **[!UICONTROL Save]**.

   ![Save button for Bizible extension configuration](assets/marketo-measure-integrations-6.png)

1. Click **[!UICONTROL Rules]**, then select **[!UICONTROL Create New Rule]**.

   ![Rules tab with Create New Rule button](assets/marketo-measure-integrations-7.png)

1. Click the **[!UICONTROL Add]** button under [!UICONTROL Events].

   ![Add button in Events section of rule configuration](assets/marketo-measure-integrations-8.png)
...
1. In the Extension drop-down, select **[!UICONTROL Core]**. Then in the Event Type drop-down, select **[!UICONTROL Library Loaded (Page Top)]**. If you don't give your event a name, a default one is applied. Click **[!UICONTROL Keep Changes]** when done.
   ...
   ![Event configuration dialog with Core extension and Library Loaded event type](assets/marketo-measure-integrations-9.png)

1. Click the **[!UICONTROL Add]** button under Actions.

   ![Add button in Actions section of rule configuration](assets/marketo-measure-integrations-10.png)
...
1. In Extension drop-down, select **[!UICONTROL Bizible Analytics]**. Then in the Action Type drop-down, select **[!UICONTROL Initialize]**. If you don't give your action a name, a default one is applied. Click **[!UICONTROL Keep Changes]** when done.
   ...
   ![Action configuration dialog with Bizible Analytics extension and Initialize action type](assets/marketo-measure-integrations-11.png)

1. Click **[!UICONTROL Save]**.

   ![Save button for rule configuration](assets/marketo-measure-integrations-12.png)
