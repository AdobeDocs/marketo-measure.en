...
!["Call Tracking" in the general sense is a product from companies such](assets/other-resources-6.png)
...
![With the integration, you can see that the web session was actually](assets/other-resources-4.png)
...
![Below is an example of a Task record with the BizibleId](assets/other-resources-5.png)
...
![The Touchpoint Type "Call" is pulled from the Task, from the](assets/marketo-engage-activities-01.png)
...
![Touchpoint Type values that Marketo Measure typically pushes are Web Visit,](assets/other-resources-1.png)
...
![If there is a value, note that we only consider all web](assets/other-resources-2.png)
